...
\begin{figure}[h]
	...
	observed that they score higher positive against these features.}
...
Cluster1 is shown in the Figure~\ref{fig:DifferencesCluster1}. It is observed
that this cluster score positive results against these features.
...
\begin{figure}[h]
	...
	this group priority care about the information that charities may provide.}
...
features. Although it is observed similar questions compared to the Cluster1
among the bottom features, they differ among the top features.
Figure~\ref{fig:DifferencesCluster2} shows the difference between the cumulative
CM1 scores for these features for Cluster2. It is observed that the majority of
the respondents of this cluster score more positive results against these
features.
...
\begin{figure}[h]
	...
	features are composed by features from questions Q9, Q7B and Q7A which
...
appears as the most negative ranked features for this cluster. The question Q7A
is observed as a top feature, and this question is only present in this cluster
as a top feature. The difference between the cumulative CM1 scores for the top
and bottom features are shown in Figure~\ref{fig:DifferencesCluster3}. The
respondents of Cluster3 score less negative results against these features.
...
\begin{figure}[h]
	...
	questions Q7A and Q7B among the most positive ranked questions indicate a high
	rate of trust and confidence in charities.}
...
Q7, Q11 and Q9 dominate among the top features. The difference between the
cumulative CM1 scores for the top and bottom features for Cluster0 is shown in the
...
indicate a high trust and confidence rate for this cluster. The difference
...
Cluster6 score strong positive results against these feature.
...
\begin{figure}[h]
	...
	positive positive features are from question Q7B which suggests a high
...
%%%% Think about the descending order and change the tables 1 and 2 then write
% again de description 
